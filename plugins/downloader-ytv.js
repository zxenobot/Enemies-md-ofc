...
await await conn.sendMessage(m.chat, { video: { url: dl_url }, fileName: `${ttl}.mp4`, mimetype: 'video/mp4', caption: `Titolo: ${ttl}`, thumbnail: await fetch(yt.thumbnail) }, { quoted: m })
} catch {
try {
